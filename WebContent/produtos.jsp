  ...
  <path fill-rule="evenodd"
					...
					<div
						...
						<a class="dropdown-item" type="button"
							onclick="listar('produtos?acao=listar')">Todos os Produtos</a> <a
							class="dropdown-item" type="button"
							onclick="listar('produtos?acao=comprados')">Produtos
							Comprados</a> <a class="dropdown-item" type="button"
							onclick="listar('produtos?acao=nao_comprados')">Produtos Não
							Comprados</a>
					</div>
				</div>
						...
						<tbody>
							<c:forEach items="${produtos}" var="prod">
								<tr>
									...
									<td data-label="Preço Real" class="text-primary">R$ <fmt:formatNumber
											type="number" maxFractionDigits="2" value="${prod.precoReal}" />
									</td>
					...
					<div class="modal-body">
						...
						<div class="form-group">
							<label for="recipient-name" class="control-label"
								...
								required="required" value="${prod.name}" maxlength="255">
						</div>
						...
						<div class="form-group">
							<label for="message-text" class="control-label">Preço
								...
								style="width: 50%;" inputmode="numeric" maxlength="12">
						</div>
					...
					<div class="modal-body">
						<div class="form-group">
							<label for="recipient-name" class="control-label">Nome:</label> <input
								...
								id="categoriaName" value="${cat.name}" required maxlength="250" />
						</div>
						<div class="form-group">
