...
public class CategoriaUtil {
     ...
     * ListaVaziaException
     */
    public static Categoria selecionarCategoria(CategoriaService service, Scanner scan) throws BackButtonException,
            NumberFormatException, OpcaoInvalidaException {
     ...
     * @throws NumberFormatException
     */
    public static void adicionarCategoria(CategoriaService service, User user) throws BackButtonException, NumberFormatException {
     ...
     * ConfirmException
     */
    public static void editarTudoCategoria(CategoriaService service, String oqVaiSerEditado, Categoria cat) throws BackButtonException, NumberFormatException {
        @SuppressWarnings("resource") Scanner scan = new Scanner(System.in);
        try {
