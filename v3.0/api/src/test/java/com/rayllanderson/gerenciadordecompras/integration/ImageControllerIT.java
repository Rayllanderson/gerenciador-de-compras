...
public class ImageControllerIT extends BaseApiTest{
    ...
    public void upload_FileUploaded_WhenSuccessful() throws Exception {
        ...
        this.mvc.perform(multipart("/api/v1/upload").file(multipartFile).headers(getHeaders())).andExpect(result ->
    ...
    public void delete_DeleteImage_whenSuccessful() throws Exception {
        ...
        ResponseEntity<Void> response = super.delete("/api/v1/upload", Void.class);
