...
<link href="resource/css/estatisticas.css" type="text/css"
	rel="stylesheet" />
...
<body>
		...
		<header>
			<nav class="navbar navbar-expand navbar-dark">
				...
				<div class="dropdown-menu dropdown-menu-right"
					...
					</a> <a class="dropdown-item" href="#"> <i class="fas fa-chart-pie"></i>
						Estatísticas
					</a>
		...
		<div class="container" style="margin-top: 5%">
			...
			<div class="card mt-3 p-3" style="border-radius: 1em">
				...
				<ul>
					<li>
						<p>
							Número total de listas: <span> ${totalListas} </span>
						</p>
					</li>
				</ul>
				...
				<ul>
					<li><p>
							Número total de produtos: <span> ${totalProdutos} </span>
						</p></li>
				</ul>

				<div class="text-center">
					<p class="text-uppercase font-weight-bold">Quantidade de
						Produtos</p>
				</div>
				...
				<div class="text-center">
					<p class="text-uppercase font-weight-bold">Valores Produtos
						Comprados</p>
				</div>

				<p>
					PS: o gráfico abaixo está levando em consideração apenas os
					produtos <a href='#' class="marcado-comprado" data-toggle="modal"
						data-target="#exampleModal"> marcados como comprados </a>
				</p>
				...
				<div class="text-center">
					<p class="text-uppercase font-weight-bold">Valores Todos os
						Produtos</p>
				</div>

				<p>PS: O gráfico abaixo está levando em consideração todos os
					produtos de todas as listas.</p>

				<canvas id="myChart2"></canvas>
				<p>Legenda:</p>
				<ul>
					<li><strong> Economizado:</strong> Subtração do preços
						estipulado com o preço do produto que foi comprado</li>
					<li><strong> Falta Gastar:</strong> Soma dos produtos que
						ainda não foram comprados</li>
					<li><strong> Valor Gasto:</strong> Soma dos <a href="#"
						class="valor-real" data-toggle="modal" data-target="#exampleModal">
							preços reais </a> dos produtos, mesmo que não estejam <a
						class="marcado-comprado" data-toggle="modal"
						data-target="#exampleModal" href="#"> marcados como comprados
					</a></li>
					<li><strong> Valor Estipulado:</strong> Soma dos preços
						estipulados dos produtos, mesmo que já tenham sido comprados</li>
					<li><strong> Valor Total:</strong> Soma dos produtos comprados
						e não comprados. Caso o produto já tenha sido comprado, leva em
						consideração seu <a class="valor-real" data-toggle="modal"
						data-target="#exampleModal" href="#"> valor real </a></li>
				</ul>
			...
			<div class="modal-dialog" role="document">
				<div class="modal-content">
					...
					<div class="modal-body">
						<p id="titulo-modal"></p>
						<img class="pb-2" alt="" id="img"
							style="border: 1px solid rgb(225, 225, 225); border-radius: 1em; margin-left: auto; margin-right: auto; display: block;">
	...
	var valorEstipuladoComprados = Number("${valorEstipComprados}")
		.toFixed(2);
	var valorEconomizadoComprados = (valorEstipuladoComprados - valorGastoComprados)
		.toFixed(2);
