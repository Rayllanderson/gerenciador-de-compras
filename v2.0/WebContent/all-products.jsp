                ...
                <div class="container">
                    ...
                    <div class="card card-signin my-5"
                        ...
                        <article class="card-body mx-auto" style="max-width: 400px;">
                            <h4 id="catTitulo" class="card-title mt-3 text-center">
                            ...
                            <p class="text-center" id="vtEstipulado"
                               title="soma total dos produtos com preço estipulado">
                                ...
                                <div class="card">
                                    ...
                                    <div id="collapseOne" class="collapse show"
                                        ...
                                        <div class="card-body" id="gerais"
                                            ...
                                            <p>
                                                Você possui <span class="text-primary font-weight-bold">
                                                ${totalProdutos} </span> produtos em <span
                                                    style="color: deeppink;" class="font-weight-bold">
                                                ${totalListas} </span> listas
                                            </p>
                                            <p>
                                                Você comprou <span class="text-primary font-weight-bold">
                                                ${numProdutosComprados} </span> produtos
                                            </p>
                                            <p>
                                            ...
                                            <p>
                                                ...
                                                ${valorGastoComprados} </span>
                                            </p>
                                            <p>
                                                Você planeja gastar <span style="color: deeppink;"
                                                                          class="font-weight-bold"> ${valorEstip} </span>
                                            </p>
                                            <p>
                                                Falta gastar <span style="color: deeppink;"
                                                                   class="font-weight-bold"> ${restante } </span>
                                            </p>
                                            <p>
                                                Valor total <span class="text-primary font-weight-bold">
                                                ${total} </span>
                                            </p>
                            ...
                            <tr>
                                ...
                                <td data-label="Excluir">
                                    <button
                                            ...
                                            data-cat_id="${prod.categoria.id}" data-nome="${prod.nome}">
                ...
                <div class="modal-body">
                    ...
                    <div id="lista" class="form-group"
                        ...
                        <c:forEach items="${categorias}" var="cat">
                            <option id="cat_id" value="${cat.id}">${cat.name}</option>
                        </c:forEach>
                    </select>
                    </div>
    ...
    <div class="modal fade" id="exampleModalCenter" tabindex="-1"
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    Você tem certeza que deseja excluir o produto <strong><span
                        id="nomeProd"></span></strong>?
                </div>
