...
<body>
<div id="landing-hero"
     class="hero is-relative is-theme-secondary hero-waves">
    <div style="height: 100vh;">
                ...
                <div class="collapse navbar-collapse" id="navbarsExample02">
                    <ul class="navbar-nav mr-auto">
                        <li class="nav-item"><a class="nav-link active" href="#"><i
                                class="fas fa-home fa-md"></i> Home</a></li>
        ...
        <div class="container">
            <div class="cartao text-center">
                <h1 class="titulo card-title mt-3 text-center">Olá,
                    ${user.name}!</h1>
                <div class="form-group">
                    <div class="main1">
                        <div class="mt-3"></div>
                        <div class="SearchBox">
                            <input type="text" id="search" class="SearchBox-input"
                ...
                <div class="form-group" style="margin-top: 3%;">
                    <a href="categorias">
                        <button class="botao btn btn-outline">
                            <i class="fas fa-clipboard fa-sm"></i> Acessar suas listas
                        </button>
                    </a>
                </div>
                ...
                <div class="form-group">
                    <a href="all-products">
                        <button class="botao btn btn-outline">
                            <i class="fas fa-shopping-bag"></i> Todos os produtos
                        </button>
                    </a>
                </div>
                ...
                <div class="form-group">
                    <a href="estatisticas">
                        <button class="botao btn btn">
                            <i class="fas fa-chart-pie"></i> Estatítiscas
                        </button>
                    </a>
                </div>
                ...
                <div class="form-group">
                    <a href="my-account">
                        <button class="botao btn btn-outline">
                            <i class="fas fa-user-circle"></i> Acessar sua conta
                        </button>
                    </a>
                </div>
