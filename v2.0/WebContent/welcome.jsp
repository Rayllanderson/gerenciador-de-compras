...
<head lang="pt-br">
    ...
    <link href="resource/css/style-login.css" type="text/css"
          rel="stylesheet"/>
        ...
        <div class="signin-signup">
            <form id="form-login" class="sign-in-form form-signin">
                ...
                <div class="form-label-group">
                    <input type="text" name="username" id="username"
                           value="${username}" class="ipt form-control user"
                           placeholder="Username" required autofocus> <label
                        for="username"> <i class="fas fa-user"></i> Username
                </label> <span class="focus-border"></span>
                </div>
                <div class="form-label-group">
                    <input type="password" id="password" name="password"
                           class="ipt form-control" placeholder="Password" required>
                    <label for="password"> <i class="fas fa-lock"></i>
                        Password
                    </label> <span class="focus-border"></span>
                </div>
                <button class="btn text-uppercase botao" id="btn-submit"
                        type="submit">Login
                </button>
            </form>
            ...
            <form id="form-cadastro" action="#" class="sign-up-form form-signin">
                ...
                <div class="input-field">
                    <i class="fas fa-user-circle"></i> <input class="ipt" type="text"
                                                              name="name" id="name" placeholder="Nome"/>
                </div>

                <div class="input-field">
                    <i class="fas fa-user"></i> <input class="ipt" type="text"
                                                       name="username-register" id="username-register"
                                                       placeholder="Username" required/>
                </div>
                <div class="input-field">
                    <i class="fas fa-lock"></i> <input class="ipt" type="password"
                                                       name="password-register" id="password-register"
                                                       placeholder="Senha" required/>
                </div>
                <div class="input-field">
                    <i class="fas fa-lock"></i> <input class="ipt" type="password"
                                                       name="password-register2" id="password-register2"
                                                       placeholder="Repita a Senha" required/>
                </div>
                <button class="btn text-uppercase botao" id="btn-register"
    ...
    <div class="panels-container">
        <div class="panel left-panel">
            <div class="content">
                ...
                <p style="font-size: 14px;">
                    ...
                    Quer saber mais detalhes? clique <a href="about.jsp"
                                                        style="color: #00E8EF">aqui</a>
                </p>
        ...
        <div class="panel right-panel">
            <div class="content">
                ...
                <p style="font-size: 14px;">Clique abaixo para realizar seu
                    login</p>
                <button class="botao" id="sign-in-btn">Login</button>
