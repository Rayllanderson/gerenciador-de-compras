...
<head>
    ...
    <meta charset="utf-8">
    <meta name="viewport"
          content="width=device-width, initial-scale=0.85, shrink-to-fit=no">
    ...
    <div class="container mt-5 ">
        ...
        <div class="card p-5">
            ...
            <p> Seu uso é bem simples: Basta você criar uma lista, adicionar os produtos e
                ...
                Seu uso fica mais interessante se você for atualizando os produtos adicionados em suas listas conforme
                você os compra.
            ...
            <p class="rodape">Vale ressaltar que este é apenas um projeto
                ...
                front-end, visto que a versão 1.0 o foco foi o back-end. Portanto,
                não é algo inovador, também não é algo extraordinário, apenas um
                projeto desenvolvido pra uso pessoal.</p>
