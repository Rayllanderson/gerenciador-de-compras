...
public class ProdutoServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        try {
            ...
            request.setAttribute("catNula", "Voc� n�o selecionou nenhuma lista!");
    ...
    private void salvarProduto(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
        ...
        } catch (CategoriaInexistenteException e) { // existe a chance da pessoa editar o html e mudar o id, ent�o n�o
            // vamos
    ...
    private void listarTodosProdutos(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
    ...
    private void setInformacoes(HttpServletRequest request, HttpServletResponse response) throws IOException {
        request.getSession().setAttribute("gerais", InformacoesProdutos.infosGerais(this.cat.getUser(), util,
                this.cat.getOrcamento()));
