...
public class CategoriaServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        try {
            ...
            setResponseBody(response, "H� um caractere inv�lido em um de seus campos", HttpServletResponse.SC_BAD_REQUEST);
    ...
    private Categoria salvarLista(HttpServletRequest request, HttpServletResponse response, User user) throws IOException,
            ServletException {
    ...
    private void listarTodasCategorias(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
