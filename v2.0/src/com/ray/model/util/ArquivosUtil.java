...
public class ArquivosUtil {
    ...
    /**
     * Converte a imagem em base 64, converte em PNG e ent�o inicia o processo de
     * cria��o de miniatura
     *
     * @param request
     *
     ...
     * @throws EntradaInvalidaException tipo de arquivo inv�lido
     */
    public static String createMiniatureBase64(HttpServletRequest request) throws IOException, ServletException,
            EntradaInvalidaException {
        if (ServletFileUpload.isMultipartContent(request)) {// validando de form � de upload
            ...
            if (imagem != null && imagem.getInputStream().available() > 0) { // siginifica que tem arquivo!
                if (imagem.getContentType().contains("image")) {
                    ...
                    throw new EntradaInvalidaException("Tipo de arquivo inv�lido");
            }
        }
        return ""; //sem arquivos
    }
     ...
     * @throws EntradaInvalidaException tipo de arquivo inv�lido
     */
    public static String createBase64(HttpServletRequest request) throws IOException, ServletException, EntradaInvalidaException {
